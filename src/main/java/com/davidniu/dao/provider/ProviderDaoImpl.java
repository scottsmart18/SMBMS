package com.davidniu.dao.provider;


import com.davidniu.dao.BaseDao;
//import com.mysql.util.StringUtils;
...
public class ProviderDaoImpl implements com.davidniu.dao.provider.ProviderDao {
    ...
    public int modify(Connection connection, Provider provider)
            throws Exception {
        System.out.println("provider ----> " + provider.getProName());
        // TODO Auto-generated method stub
        int flag = 0;
        PreparedStatement pstm = null;
        if (null != connection) {
